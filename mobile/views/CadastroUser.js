    ...
    return(
        <KeyboardAvoidingView behavior={Platform.OS == 'ios' ? "padding" : "height"} style={[css.container, css.darkbg]}>
            ...
            <View style={css.login_form}>
                ...
                <TextInput style={css.login_input} value={raca} placeholder="CPF" onChangeText={text=>setRaca(text)}/>
                <TextInput style={css.login_input} value={nascimento} placeholder="Email" onChangeText={text=>setNascimento(text)}/>
                <TextInput style={css.login_input} value={chegada} placeholder="Telefone" onChangeText={text=>setChegada(text)}/>
                <TextInput style={css.login_input} value={chegada} placeholder="Tipo" onChangeText={text=>setChegada(text)}/>
                <TextInput style={css.login_input} value={chegada} placeholder="Senha" onChangeText={text=>setChegada(text)}/>
